...
- [ ] T001 Initialize Python project with uv in My_AI_Employee/ directory
- [ ] T002 Add dependencies to pyproject.toml: watchdog, python-frontmatter, pytest
- [ ] T003 [P] Create .env.example file with VAULT_PATH and WATCH_FOLDER configuration
- [ ] T004 [P] Create .gitignore to exclude .env, __pycache__, .pytest_cache, dedupe state files
- [ ] T005 Create My_AI_Employee/__init__.py as package marker
...
- [ ] T006 Use @obsidian-vault-ops skill to create vault structure at My_AI_Employee/AI_Employee_Vault/
- [ ] T007 Verify vault contains: Inbox/, Needs_Action/, Done/, Plans/, Dashboard.md, Company_Handbook.md
- [ ] T008 [P] Create My_AI_Employee/utils/__init__.py for shared utilities
- [ ] T009 [P] Create My_AI_Employee/utils/frontmatter_utils.py with load_action_item() and save_action_item() using frontmatter.load/dump
- [ ] T010 [P] Create My_AI_Employee/utils/dedupe_state.py with DedupeTracker class (JSON file outside vault)
- [ ] T011 Create My_AI_Employee/watchers/__init__.py for watcher modules
- [ ] T012 Create My_AI_Employee/watchers/base_watcher.py with BaseWatcher abstract class pattern
...
- [ ] T013 [P] [US1] Create My_AI_Employee/watchers/filesystem_watcher.py with FilesystemWatcher class
- [ ] T014 [US1] Implement FilesystemWatcher.__init__() with vault_path, watch_folder, watch_mode (events/polling) config
- [ ] T015 [US1] Implement FilesystemWatcher.on_created() handler using watchdog FileSystemEventHandler.on_created()
- [ ] T016 [US1] Implement FilesystemWatcher._create_action_item() to generate Needs_Action/*.md with frontmatter (type, received, status)
- [ ] T017 [US1] Implement FilesystemWatcher._generate_stable_id() for duplicate prevention using file path + stat info
- [ ] T018 [US1] Integrate DedupeTracker in FilesystemWatcher to prevent duplicate action items (FR-007)
- [ ] T019 [US1] Implement FilesystemWatcher.run() with Observer (native events) and PollingObserver fallback for WSL
- [ ] T020 [US1] Add error handling in FilesystemWatcher: log errors, continue running (FR-008)
- [ ] T021 [US1] Create My_AI_Employee/run_watcher.py entrypoint script with argparse for vault_path and watch_folder
- [ ] T022 [US1] Test watcher manually using @watcher-runner-filesystem skill
...
- [ ] T023 [P] [US5] Create tests/test_action_item_format.py with test_action_item_has_required_frontmatter()
- [ ] T024 [P] [US5] Add test_action_item_received_is_iso_timestamp() to validate ISO 8601 format
- [ ] T025 [P] [US5] Add test_file_drop_references_original_path() to validate FR-006
- [ ] T026 [P] [US5] Add test_frontmatter_preservation_on_load_dump() using frontmatter.load() and frontmatter.dump()

### Tests for User Story 1 (FR-017 requirement)

- [ ] T027 [P] [US1] Create tests/test_watcher_core.py with test_watcher_creates_action_item()
- [ ] T028 [P] [US1] Add test_watcher_prevents_duplicates() to validate dedupe logic
- [ ] T029 [P] [US1] Add test_watcher_continues_after_error() to validate FR-008 resilience
- [ ] T030 [US1] Run pytest and ensure all US1 and US5 tests pass
...
- [ ] T031 [P] [US2] Create My_AI_Employee/vault_ops/__init__.py for vault operations
- [ ] T032 [P] [US2] Create My_AI_Employee/vault_ops/action_item_reader.py with read_pending_items() function
- [ ] T033 [P] [US2] Create My_AI_Employee/vault_ops/plan_writer.py with create_plan() function for Plans/ folder
- [ ] T034 [US2] Create My_AI_Employee/vault_ops/item_archiver.py with archive_to_done() using frontmatter.load/dump (FR-014)
- [ ] T035 [US2] Implement archive_to_done() to preserve YAML frontmatter and add status: processed
- [ ] T036 [US2] Create My_AI_Employee/triage/__init__.py for triage logic
- [ ] T037 [US2] Create My_AI_Employee/triage/handbook_reader.py with read_handbook_rules() for Company_Handbook.md
- [ ] T038 [US2] Create My_AI_Employee/triage/plan_generator.py with generate_plan_content() (checkboxes, done condition)
- [ ] T039 [US2] Implement malformed item detection in triage: leave in Needs_Action/, add dashboard warning (FR-015)
- [ ] T040 [US2] Test triage workflow manually using @needs-action-triage skill
...
- [ ] T041 [P] [US3] Create My_AI_Employee/vault_ops/dashboard_updater.py with DashboardUpdater class
- [ ] T042 [US3] Implement DashboardUpdater.update_pending_count() to count files in Needs_Action/
- [ ] T043 [US3] Implement DashboardUpdater.add_recent_activity() with timestamp and item reference
- [ ] T044 [US3] Implement DashboardUpdater.add_warning() for malformed items
- [ ] T045 [US3] Implement DashboardUpdater._update_section() for non-destructive dashboard updates (preserve user notes)
- [ ] T046 [US3] Integrate DashboardUpdater into triage workflow in My_AI_Employee/triage/
...
- [ ] T047 [P] [US4] Create My_AI_Employee/vault_ops/vault_validator.py with VaultValidator class
- [ ] T048 [US4] Implement VaultValidator.validate_structure() to check required folders and files (FR-001)
- [ ] T049 [US4] Implement VaultValidator.validate_plans_folder() to check Plans/ behavior (FR-002)
- [ ] T050 [US4] Add vault validation to @obsidian-vault-ops skill workflow
- [ ] T051 [US4] Test vault validation using @obsidian-vault-ops skill
...
- [ ] T052 [P] Create README.md with setup instructions, dependencies, and usage examples
- [ ] T053 [P] Create My_AI_Employee/config.py for centralized configuration management
- [ ] T054 [P] Add logging configuration in My_AI_Employee/utils/logger.py
- [ ] T055 Add comprehensive docstrings to all modules following Google style
- [ ] T056 Run @bronze-demo-check skill to validate end-to-end Bronze tier acceptance
- [ ] T057 Verify all acceptance scenarios from spec.md are satisfied
- [ ] T058 [P] Create QUICKSTART.md with step-by-step demo instructions
- [ ] T059 Run final pytest suite and ensure 100% pass rate
- [ ] T060 Verify no secrets committed and .env.example is complete
