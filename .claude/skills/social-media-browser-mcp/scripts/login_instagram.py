#!/usr/bin/env python3
"""
Instagram Login Helper - Authenticate and save browser session for social media automation

This script opens a browser to Instagram login page and waits for manual authentication.
Once authenticated, the session is saved to .social_session/instagram/ for reuse.
...
async def login_instagram():
    """
    Open Instagram login page and wait for user to authenticate.

    Session is automatically saved to .social_session/instagram/ for reuse.
    """
    platform_dir = SESSION_DIR / PLATFORM
    platform_dir.mkdir(parents=True, exist_ok=True)

    logger.info(f"Starting Instagram login helper")
    ...
    try:
        ...
        await page.goto(INSTAGRAM_URL, timeout=30000)

        # Wait for user to log in
        logger.info("")
        logger.info("=" * 70)
        logger.info("BROWSER OPENED - Please log in to Instagram")
        logger.info("=" * 70)
        logger.info("")
        logger.info("Instructions:")
        logger.info("1. Log in to Instagram with your credentials")
        ...
        try:
            ...
            logger.info("")
            logger.info("Session saved. You can now use Instagram posting tools.")
            logger.info("")
        except:
        ...
        logger.info("- Use MCP tool: post_to_instagram")
