...
## Email MCP Server (`scripts/email_mcp.py`)
...
## LinkedIn MCP Server (`scripts/servers/linkedin_mcp.py`)
...
## Browser Automation MCP Server (`scripts/servers/playwright_mcp.py`)
...
```bash
# Start email server
python scripts/servers/email_mcp.py

# In another terminal, start LinkedIn server
python scripts/servers/linkedin_mcp.py

# In another terminal, start browser server
python scripts/servers/playwright_mcp.py
```
...
# Or with PM2
pm2 start scripts/servers/email_mcp.py --name "email-mcp"
pm2 start scripts/servers/linkedin_mcp.py --name "linkedin-mcp"
pm2 start scripts/servers/playwright_mcp.py --name "browser-mcp"
```
